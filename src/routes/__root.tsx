...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Decision-support platform for first-time urban poultry keepers in Kenya." },
      { property: "og:title", content: "PoultryFit Kenya" },
      { property: "og:description", content: "Plan a feasible flock based on your space and budget." },
